...
@RestController
@RequestMapping(value = PUBLIC_API_V1 + "/portfolio/{portfolioId:" + MATCH_NUMBER + "}/summary",
    produces = WebConstants.APPLICATION_JSON_UTF8)
@PublicVisibility(PortfolioComponent.STUDIES)
public class PublicSummaryResource extends AbstractResource {

    private final PortfolioService portfolioService;

    @Autowired
    public PublicSummaryResource(PortfolioService portfolioService) {
