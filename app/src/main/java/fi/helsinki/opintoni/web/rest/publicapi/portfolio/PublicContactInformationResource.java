...
@RestController
@RequestMapping(value = PUBLIC_API_V1 + "/portfolio/{portfolioId:" + MATCH_NUMBER + "}/contactinformation",
    produces = WebConstants.APPLICATION_JSON_UTF8)
@PublicVisibility(PortfolioComponent.CONTACT_INFORMATION)
public class PublicContactInformationResource extends AbstractResource {

    private final ContactInformationService contactInformationService;

    @Autowired
    public PublicContactInformationResource(ContactInformationService contactInformationService) {
