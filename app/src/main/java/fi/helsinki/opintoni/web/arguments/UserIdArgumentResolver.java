...
public class UserIdArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public UserIdArgumentResolver(UserService userService, SecurityUtils securityUtils) {
    ...
    public Object resolveArgument(
        ...
        return securityUtils.getAppUser()
            ...
            .flatMap(userService::findFirstByEduPersonPrincipalName)
            .map(user -> user.id)
            .orElseThrow(forbiddenException("Principal not found or user has no user id"));
    }
}
