...
public class StudentNumberArgumentResolver implements HandlerMethodArgumentResolver {

    private final SecurityUtils securityUtils;

    public StudentNumberArgumentResolver(SecurityUtils securityUtils) {
    ...
    public Object resolveArgument(
        ...
        return securityUtils.getAppUser()
            .flatMap(AppUser::getStudentNumber)
            .orElseThrow(forbiddenException("Principal not found or user has no student number"));
    }
}
