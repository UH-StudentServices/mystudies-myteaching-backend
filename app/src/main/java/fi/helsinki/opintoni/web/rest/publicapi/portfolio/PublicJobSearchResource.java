...
@RestController
@RequestMapping(
    value = RestConstants.PUBLIC_API_V1 + "/portfolio/{portfolioId:" + RestConstants.MATCH_NUMBER + "}/jobsearch",
    produces = WebConstants.APPLICATION_JSON_UTF8)
@PublicVisibility(PortfolioComponent.WORK_EXPERIENCE)
public class PublicJobSearchResource extends AbstractResource {

    private final JobSearchService jobSearchService;

    @Autowired
    public PublicJobSearchResource(JobSearchService jobSearchService) {
