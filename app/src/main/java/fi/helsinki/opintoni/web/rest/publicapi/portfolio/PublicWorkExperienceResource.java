...
@RestController
@RequestMapping(
    value = RestConstants.PUBLIC_API_V1 + "/portfolio/{portfolioId:" + RestConstants.MATCH_NUMBER + "}/workexperience",
    produces = WebConstants.APPLICATION_JSON_UTF8)
@PublicVisibility(PortfolioComponent.WORK_EXPERIENCE)
public class PublicWorkExperienceResource extends AbstractResource {

    private final WorkExperienceService workExperienceService;

    @Autowired
    public PublicWorkExperienceResource(WorkExperienceService workExperienceService) {
