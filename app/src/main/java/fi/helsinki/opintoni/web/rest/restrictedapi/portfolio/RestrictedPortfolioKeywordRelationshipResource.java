...
@RestController
@RequestMapping(
    value = RestConstants.RESTRICTED_API_V1 + "/portfolio/{portfolioId:" + RestConstants.MATCH_NUMBER + "}/keyword",
    produces = WebConstants.APPLICATION_JSON_UTF8)
@PublicVisibility(PortfolioComponent.STUDIES)
public class RestrictedPortfolioKeywordRelationshipResource extends AbstractResource {

    private final PortfolioKeywordRelationshipService portfolioKeywordRelationshipService;

    @Autowired
    public RestrictedPortfolioKeywordRelationshipResource(
