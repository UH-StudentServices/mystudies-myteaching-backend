...
@RestController
@RequestMapping(
    value = RestConstants.PUBLIC_API_V1 + "/portfolio/{portfolioId:" + RestConstants.MATCH_NUMBER + "}/degree",
    produces = WebConstants.APPLICATION_JSON_UTF8)
@PublicVisibility(PortfolioComponent.DEGREES)
public class PublicDegreeResource extends AbstractResource {

    private final DegreeService degreeService;

    @Autowired
    public PublicDegreeResource(DegreeService degreeService) {
