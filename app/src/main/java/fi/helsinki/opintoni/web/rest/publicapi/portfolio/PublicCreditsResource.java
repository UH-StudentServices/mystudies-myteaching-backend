...
@RestController
@RequestMapping(
    value = RestConstants.PUBLIC_API_V1 + "/portfolio/{portfolioId:" + RestConstants.MATCH_NUMBER + "}/credits",
    produces = WebConstants.APPLICATION_JSON_UTF8)
@PublicVisibility(PortfolioComponent.CREDITS)
public class PublicCreditsResource extends AbstractResource {

    private final CreditsService creditsService;

    @Autowired
    public PublicCreditsResource(CreditsService creditsService) {
