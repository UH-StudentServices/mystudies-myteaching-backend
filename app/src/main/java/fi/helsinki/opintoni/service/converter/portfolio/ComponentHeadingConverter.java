...
@Component
public class ComponentHeadingConverter {

    public ComponentHeadingDto toDto(ComponentHeading componentHeading) {
        ComponentHeadingDto componentHeadingDto = new ComponentHeadingDto();
        componentHeadingDto.component = componentHeading.component;
        componentHeadingDto.heading = componentHeading.heading;

        return componentHeadingDto;
    }
...
public class ComponentOrderConverter {
    ...
    public ComponentOrder toEntity(Portfolio portfolio, ComponentOrderDto componentOrderDto) {
        ComponentOrder componentOrder = new ComponentOrder();

        componentOrder.portfolio = portfolio;
