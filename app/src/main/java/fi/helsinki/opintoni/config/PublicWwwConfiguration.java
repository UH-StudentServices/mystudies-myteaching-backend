...
@Configuration
public class PublicWwwConfiguration {

    @Autowired
    private AppConfiguration appConfiguration;

    @Bean
    public RestTemplate publicWwwRestTemplate() {
    ...
    @Bean
    public PublicWwwRestClient publicWwwRestClient() {
        return new PublicWwwRestClient(appConfiguration.get("publicWww.base.url"), publicWwwRestTemplate());
    }
