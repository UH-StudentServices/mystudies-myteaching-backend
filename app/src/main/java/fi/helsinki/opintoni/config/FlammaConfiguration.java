...
@Configuration
public class FlammaConfiguration {
    ...
    @Bean
    public FlammaRestClient flammaRestClient() {
        return new FlammaRestClient(appConfiguration.get("flamma.base.url"), flammaRestTemplate());
    }
