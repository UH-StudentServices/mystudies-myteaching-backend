...
public class RestrictedWorkExperienceResourcePermissionTest extends SpringTest {

    @Autowired
    private PortfolioRepository portfolioRepository;

    private void getWorkExperience(ResultMatcher expectedResult) throws Exception {
        mockMvc.perform(get("/api/restricted/v1/portfolio/2/workexperience")
    ...
    @Test
    public void thatUserCannotGetWorkExperienceFromPrivatePortfolioSheDoesNotOwnThroughRestrictedApi() throws
        Exception {
        getWorkExperience(status().isNotFound());
    }

    @Test
    public void thatUserCanGetWorkExperienceFromRestrictedPortfolioSheDoesNotOwnThroughRestrictedApi() throws
        Exception {
