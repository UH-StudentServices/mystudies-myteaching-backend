...
public class CourseImplementationRequestChain<T> implements NestedRequestChain<T> {
    ...
    public CourseImplementationRequestChain<T> activity(String responseFile) {
        coursePageServer.expectCourseImplementationActivityRequest(courseImplementationId,
            responseFile);
        return this;
    }
