...
public class EnrollmentResourceGetStudentEventsTest extends SpringTest {
    ...
    public void thatStudentEventsAreReturned() throws Exception {
        ...
        mockMvc.perform(get("/api/private/v1/students/enrollments/events")
            ...
            .andExpect(jsonPath("$[0].endDate[0]").value(2014))
            .andExpect(jsonPath("$[0].endDate[1]").value(10))
            .andExpect(jsonPath("$[0].endDate[2]").value(27))
            .andExpect(jsonPath("$[0].endDate[3]").value(13))
            .andExpect(jsonPath("$[0].endDate[4]").value(45))
            .andExpect(jsonPath("$[0].locations").value("Päärakennus, sali 1, Viikinkaari 11"))
            ...
            .andExpect(jsonPath("$[0].locations").value("Päärakennus, sali 1, Viikinkaari 11"))
            .andExpect(jsonPath("$[0].title").value("Johdatus kasvatuspsykologiaan"))
