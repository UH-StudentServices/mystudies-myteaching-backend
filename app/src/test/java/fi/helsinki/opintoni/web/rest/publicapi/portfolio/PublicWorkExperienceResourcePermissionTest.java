...
public class PublicWorkExperienceResourcePermissionTest extends SpringTest {

    @Autowired
    private PortfolioRepository portfolioRepository;

    private void getWorkExperience(ResultMatcher expectedResult) throws Exception {
        mockMvc.perform(get("/api/public/v1/portfolio/2/workexperience")
    ...
    @Test
    public void thatUserCannotGetWorkExperienceFromPrivatePortfolioSheDoesNotOwnThroughPublicApi() throws Exception {
        getWorkExperience(status().isNotFound());
    }

    @Test
    public void thatUserCanGetWorkExperienceFromPublicPortfolioSheDoesNotOwnThroughPublicApi() throws Exception {
