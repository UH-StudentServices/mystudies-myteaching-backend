...
public enum TeachingLanguage {
    ...
    TeachingLanguage(String code, ImmutableMap<String, String> localizedNames) {
        this.code = code;
        this.localizedNames = localizedNames;
    }

    public static List<String> getCodes() {
        return Arrays.stream(TeachingLanguage.values()).map(TeachingLanguage::getCode).collect(Collectors.toList());
    }

    public static TeachingLanguage fromCode(String code) {
        return Optional.of(TeachingLanguage.valueOf(code.toUpperCase()))
