...
import fi.helsinki.opintoni.domain.converter.profile.LanguageConverter;
...
@Entity
@Table(name = "profile")
public class Profile extends AbstractAuditingEntity implements Ownership {
    ...
    public String toString() {
        return new ToStringBuilder(this)
            ...
            .append("profileRole", profileRole.name())
            .toString();
    }
}
