...
public interface WorkExperienceRepository extends JpaRepository<WorkExperience, Long> {
    ...
    List<WorkExperience> findByProfileIdOrderByOrderIndexAsc(Long profileId);

    List<WorkExperience> findByProfileIdAndVisibilityOrderByOrderIndexAsc(Long profileId, ComponentVisibility.Visibility visibility);
