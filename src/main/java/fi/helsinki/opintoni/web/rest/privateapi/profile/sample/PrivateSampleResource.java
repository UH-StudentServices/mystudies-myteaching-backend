...
package fi.helsinki.opintoni.web.rest.privateapi.profile.sample;
...
@RestController
@RequestMapping(
    value = RestConstants.PRIVATE_API_V1_PROFILE + "/{profileId:" + RestConstants.MATCH_NUMBER + "}/samples",
...
public class PrivateSampleResource extends AbstractResource {
    ...
    public ResponseEntity<List<SampleDto>> update(@UserId Long userId,
        ...
        return response(sampleService.updateSamples(profileId, updateSamples));
    }
}
