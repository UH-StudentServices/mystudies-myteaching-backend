...
@Component
public class RestrictedPortfolioInterceptor extends HandlerInterceptorAdapter {
    ...
    @Autowired
    public RestrictedPortfolioInterceptor(PortfolioRequestResolver portfolioRequestResolver,
    ...
    private void verifyPortfolioVisibility(PortfolioDto portfolioDto) {
        if (portfolioDto.visibility == PortfolioVisibility.PRIVATE) {
