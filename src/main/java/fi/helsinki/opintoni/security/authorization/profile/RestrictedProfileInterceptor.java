...
@Component
public class RestrictedProfileInterceptor extends HandlerInterceptorAdapter {
    ...
    @Autowired
    public RestrictedProfileInterceptor(ProfileRequestResolver profileRequestResolver,
    ...
    private void verifyProfileVisibility(ProfileDto profileDto) {
        if (profileDto.visibility == ProfileVisibility.PRIVATE) {
