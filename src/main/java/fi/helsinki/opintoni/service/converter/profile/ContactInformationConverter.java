...
import fi.helsinki.opintoni.service.profile.SomeLinkService;
...
public class ContactInformationConverter {
    ...
    public ContactInformationDto toDto(ContactInformation contactInformation, long profileId) {
        ...
        contactInformationDto.someLinks = someLinkService.findByProfileId(profileId);
        return contactInformationDto;
    }

    public ContactInformationDto toDto(ContactInformation contactInformation) {
        return toDto(contactInformation, contactInformation.profile.id);
    }
}
