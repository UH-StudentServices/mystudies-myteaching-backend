...
@Component
@ConfigurationProperties(prefix = "user-defaults.faculty-useful-links")
public class FacultyUsefulLinksProperties {
    ...
    public void setTeacherFacultyLinks(List<Map<String, String>> teacherFacultyLinks) {
        this.teacherFacultyLinks = teacherFacultyLinks;
    }
}
