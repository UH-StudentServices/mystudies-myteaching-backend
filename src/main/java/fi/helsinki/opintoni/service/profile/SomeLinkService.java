...
import fi.helsinki.opintoni.service.converter.profile.SomeLinkConverter;
...
public class SomeLinkService extends DtoService {
    ...
    public List<SomeLinkDto> findByProfileId(Long profileId) {
        return getDtos(profileId,
            someLinkRepository::findByProfileId,
