...
public class PrivateComponentHeadingResourcePermissionTest extends SpringTest {
    ...
    @Test
    public void thatUserCannotUpdateHeadingsForSomeoneElsesProfile() throws Exception {
    ...
    @Test
    public void thatUserCannotDeleteHeadingsFromSomeoneElsesProfile() throws Exception {
        ComponentHeadingDto componentHeadingDto = new ComponentHeadingDto();
        componentHeadingDto.component = ProfileComponent.STUDIES;
        componentHeadingDto.heading = "Test heading";
        ...
        mockMvc.perform(delete(RESOURCE_URL + '/' + ProfileComponent.STUDIES.toString())
            .with(securityContext(teacherSecurityContext()))).andExpect(status().isNotFound());
