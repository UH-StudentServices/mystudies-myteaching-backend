...
public class PrivateProfileAttainmentResourcePermissionTest extends SpringTest {
    ...
    @Test
    public void thatUserCannotUpdateWhitelistToProfileSheDoesNotOwn() throws Exception {
