...
public class PrivatePortfolioSharedLinkResourcePermissionTest extends SpringTest {
    ...
    @Test
    public void thatUserCantAddSharedLinkToPortfolioSheDoesntOwn() throws Exception {
