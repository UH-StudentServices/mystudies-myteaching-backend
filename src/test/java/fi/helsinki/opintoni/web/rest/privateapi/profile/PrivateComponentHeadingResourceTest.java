...
public class PrivateComponentHeadingResourceTest extends SpringTest {
    ...
    private static final String STUDENT_API_PATH_SEGMENT = "/profile/2/component-headings";
    ...
    public void thatComponentHeadingCanBeAdded() throws Exception {
        ...
        componentHeadingDto.component = ProfileComponent.ATTAINMENTS;
        ...
        assertThat(componentHeadingRepository.findByProfileId(STUDENT_PROFILE_ID)).hasSize(3);
    }

    @Test
    public void thatComponentHeadingCanBeUpdated() throws Exception {
        ComponentHeadingDto componentHeadingDto = new ComponentHeadingDto();
        componentHeadingDto.component = ProfileComponent.STUDIES;
        ...
        List<ComponentHeading> componentHeadings = componentHeadingRepository.findByProfileId(STUDENT_PROFILE_ID);
    ...
    public void thatComponentHeadingIsDeleted() throws Exception {
        ...
        String componentPath = STUDENT_API_PATH_SEGMENT + "/" + ProfileComponent.STUDIES.toString();

        mockMvc.perform(delete(RestConstants.PRIVATE_API_V1 + componentPath)
            .with(securityContext(studentSecurityContext())));

        assertThat(componentHeadingRepository.findByProfileId(STUDENT_PROFILE_ID)).hasSize(1);
    }
}
