...
public class PrivateComponentHeadingResourcePermissionTest extends SpringTest {
    ...
    @Test
    public void thatUserCannotDeleteHeadingsFromSomeoneElsesPortfolio() throws Exception {
        ComponentHeadingDto componentHeadingDto = new ComponentHeadingDto();
        componentHeadingDto.component = PortfolioComponent.STUDIES;
        componentHeadingDto.heading = "Test heading";
        ...
        mockMvc.perform(delete(RESOURCE_URL + '/' + PortfolioComponent.STUDIES.toString())
