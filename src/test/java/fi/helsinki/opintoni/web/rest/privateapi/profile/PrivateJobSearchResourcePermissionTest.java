...
public class PrivateJobSearchResourcePermissionTest extends SpringTest {
    ...
    @Test
    public void thatUserCannotSaveJobSearchToProfileSheDoesNotOwn() throws Exception {
    ...
    @Test
    public void thatUserCannotDeleteJobSearchFromProfileSheDoesNotOwn() throws Exception {
        mockMvc.perform(delete(RESOURCE_URL).with(securityContext(teacherSecurityContext()))
            .characterEncoding("UTF-8")
            .contentType(MediaType.APPLICATION_JSON)
            .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isNotFound());
