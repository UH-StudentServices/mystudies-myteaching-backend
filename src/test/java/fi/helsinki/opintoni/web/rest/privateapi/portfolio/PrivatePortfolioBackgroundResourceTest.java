...
public class PrivatePortfolioBackgroundResourceTest extends SpringTest {
    ...
    public void thatBackgroundCanBeSelectedFromDefaults() throws Exception {
        ...
        Optional<PortfolioBackground> background = portfolioBackgroundRepository.findByPortfolioId(PORTFOLIO_ID);
    ...
    private void addUploadedBackgroundToDbAndFileSystem(String uploadedBackgroundFilename) {
        PortfolioBackground background = new PortfolioBackground();
