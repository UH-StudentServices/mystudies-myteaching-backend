...
public class StudyAttainmentSampleData {
    ...
    public static final String TEACHER_NAME = "Opettaja Olli";
    public static final List<TeacherDto> TEACHERS = Collections.singletonList(new TeacherDto(TEACHER_NAME));
}
